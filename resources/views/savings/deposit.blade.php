    ...
    <div class="max-w-xl space-y-6">
        ...
        <form method="POST" action="{{ route('savings.deposit.store') }}" enctype="multipart/form-data" class="bg-white rounded-[16px] shadow-sm border border-slate-200 p-6 space-y-5" x-data="moneyForm()">
            ...
            <div>
                ...
                <div x-data="memberSearch(@json($members->map(fn($m) => ['id' => $m->id, 'first_name' => $m->first_name, 'last_name' => $m->last_name, 'staff_id' => $m->staff_id, 'staff_id_display' => $m->staff_id_display, 'account_number' => $m->savingsAccount?->account_number ?? ''])))" x-init="init()">
                    <div class="relative">
