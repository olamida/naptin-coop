<x-app-layout title="Declare Dividend">
    <div class="max-w-xl space-y-6">
        <div class="flex items-center gap-3">
            ...
            <h2 class="text-xl font-bold text-[#0F172A]">Declare Dividend</h2>
        </div>

        <div class="bg-white rounded-[16px] shadow-sm border border-slate-200 p-6">
            <p class="text-sm text-slate-600 mb-6">Create a new dividend record for the year. After creation, you can calculate distributions based on share holdings.</p>
            ...
            <form method="POST" action="{{ route('dividends.store') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <select name="year" required class="w-full px-3 py-2 border border-slate-300 rounded-[10px] text-sm focus:ring-2 focus:ring-blue-500 outline-none">
                ...
                <div>
                    <label class="block text-sm font-medium text-slate-700 mb-1">Total Profit to Distribute (₦) *</label>
                ...
                <div class="flex items-center gap-3 pt-2">
                    ...
                    <a href="{{ route('dividends.index') }}" class="text-sm text-slate-500 hover:text-slate-700">Cancel</a>
                </div>
            </form>
        </div>
    </div>
