<x-app-layout title="Import Members">
    <div class="max-w-2xl mx-auto space-y-6">
        <div class="flex items-center gap-3">
            ...
            <h2 class="text-2xl font-bold text-gray-800">Import Members</h2>
        </div>

        <div class="flex items-center gap-2 text-sm text-gray-500">
            <a href="{{ route('admin.data-import') }}" class="hover:text-indigo-600 transition">Data Import</a>
            <span class="material-symbols-outlined text-[16px]">chevron_right</span>
            <span class="text-gray-800 font-medium">Import Members</span>
        </div>
