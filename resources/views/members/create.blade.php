<x-app-layout title="Add Member">
    <div class="max-w-3xl space-y-6">
        ...
        <form method="POST" action="{{ route('members.store') }}" enctype="multipart/form-data" class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-6">
            @csrf
                    ...
                    <div class="md:col-span-1">
                        ...
                        <div x-data="{ preview: null }" class="text-center">
                            <div x-show="preview" class="mb-3">
                                <img :src="preview" class="w-28 h-28 rounded-full object-cover mx-auto border-4 border-gray-200">
                            </div>
                            <div x-show="!preview" class="w-28 h-28 rounded-full bg-gray-100 flex items-center justify-center mx-auto mb-3 border-4 border-dashed border-gray-300">
            ...
            <fieldset class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="address" rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 outline-none">{{ old('address') }}</textarea>
                    </div>
                </div>
            </fieldset>
            ...
            <div class="flex items-center gap-3 pt-4 border-t border-gray-100">
                ...
                <a href="{{ route('members.index') }}" class="text-sm text-gray-500 hover:text-gray-700">Cancel</a>
            </div>
        </form>
    </div>
</x-app-layout>
