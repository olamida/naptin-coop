    ...
    <div class="space-y-6" x-data="{ printMode: false }">
        <div class="flex items-center justify-between no-print">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-[#0F172A]">Savings Deduction Report</h2>
            ...
            <table class="w-full text-sm">
                <thead class="bg-slate-50 border-b border-slate-200">
                    <tr>
                        ...
                        <th class="text-right px-4 py-3 font-medium text-slate-600">Monthly Salary</th>
                        <th class="text-right px-4 py-3 font-medium text-slate-600">Expected Savings</th>
                        <th class="text-right px-4 py-3 font-medium text-slate-600">Actual Savings</th>
