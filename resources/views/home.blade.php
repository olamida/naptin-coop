<x-public-layout title="Home">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
            <div class="max-w-2xl">
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="{{ route('shop') }}" class="bg-white text-blue-700 hover:bg-blue-50 px-6 py-3 rounded-lg font-semibold text-sm transition shadow-lg">
                        Browse Shop
                    </a>
                    @guest
                        <a href="{{ route('login') }}" class="border-2 border-white/40 text-white hover:bg-white/10 px-6 py-3 rounded-lg font-semibold text-sm transition">
                            Member Login
                        </a>
                    @else
                        @if (Auth::user()->member_id ?? false)
                            <a href="{{ route('portal.dashboard') }}" class="border-2 border-white/40 text-white hover:bg-white/10 px-6 py-3 rounded-lg font-semibold text-sm transition">
                                My Dashboard
                            </a>
                        @endif
                    @endguest
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between mb-8">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-1">Browse items available in our cooperative shop</p>
                    </div>
                    ...
                    @foreach ($featuredProducts as $product)
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition group">
                            ...
                            <div class="p-4">
                                ...
                                <p class="text-xs text-gray-500 line-clamp-2 mb-3">{{ $product->description ?? 'No description available' }}</p>
    ...
    <section class="bg-white py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div>
                    <h2 class="text-2xl font-bold text-gray-800 mb-4">About Our Cooperative</h2>
                    ...
                    <ul class="space-y-3 mb-8">
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-sm text-gray-600">Competitive savings interest rates</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="material-symbols-outlined text-green-500 text-lg mt-0.5">check_circle</span>
                            <span class="text-sm text-gray-600">Affordable loan products with flexible repayment</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="material-symbols-outlined text-green-500 text-lg mt-0.5">check_circle</span>
                            <span class="text-sm text-gray-600">Annual dividend distributions</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="material-symbols-outlined text-green-500 text-lg mt-0.5">check_circle</span>
                            <span class="text-sm text-gray-600">Wide range of products at cooperative prices</span>
                        </li>
                    </ul>
                    <a href="{{ route('about') }}" class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg text-sm font-medium transition">
                        Learn More About Us
                        <span class="material-symbols-outlined text-lg">arrow_forward</span>
                    </a>
                </div>
                <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-8">
                    <div class="grid grid-cols-2 gap-4">
                        <div class="bg-white rounded-xl p-4 text-center shadow-sm">
                            ...
                            <p class="text-sm font-semibold text-gray-800">Savings</p>
                            <p class="text-xs text-gray-500">Grow your savings securely</p>
                        </div>
                        <div class="bg-white rounded-xl p-4 text-center shadow-sm">
                            <span class="material-symbols-outlined text-blue-600 text-3xl mb-2">account_balance</span>
                            <p class="text-sm font-semibold text-gray-800">Loans</p>
                            <p class="text-xs text-gray-500">Access affordable credit</p>
                        </div>
                        <div class="bg-white rounded-xl p-4 text-center shadow-sm">
                            <span class="material-symbols-outlined text-blue-600 text-3xl mb-2">trending_up</span>
                            <p class="text-sm font-semibold text-gray-800">Shares</p>
                            <p class="text-xs text-gray-500">Invest and earn dividends</p>
                        </div>
                        <div class="bg-white rounded-xl p-4 text-center shadow-sm">
                            <span class="material-symbols-outlined text-blue-600 text-3xl mb-2">storefront</span>
                            <p class="text-sm font-semibold text-gray-800">Shop</p>
                            <p class="text-xs text-gray-500">Buy on cooperative terms</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="bg-gray-50 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-sm text-gray-500 mb-8">Have questions? We'd love to hear from you.</p>
