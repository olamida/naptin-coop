    ...
    <div class="min-h-screen flex flex-col lg:flex-row" :class="serverDown ? 'pt-10' : ''" style="transition: padding-top 0.3s ease;">
        ...
        <div class="hidden lg:block lg:w-1/2 relative overflow-hidden">
            <div class="absolute inset-0">
                <div class="absolute inset-0 bg-cover bg-center" style="background-image: url('{{ $heroA }}');"></div>
            ...
            <div class="relative h-full flex flex-col justify-between p-12 text-white">
                ...
                <div>
                    <h1 class="text-3xl xl:text-4xl font-extrabold leading-tight mb-4">Your cooperative, in one secure place.</h1>
                    <p class="text-slate-200 text-sm leading-relaxed max-w-md">Savings, loans, shares, payroll and dividends — sign in to manage your cooperative or access your member portal.</p>
                </div>
                ...
                <div class="flex flex-wrap gap-3 text-xs text-slate-300 mt-6">
                    ...
                    <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/10">
                        <span class="material-symbols-outlined text-[16px]">trending_up</span> Shares
                    </span>
                    <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/10">
