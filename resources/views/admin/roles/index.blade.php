    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">{{ $roles->count() }} roles &middot; {{ $permissions->count() }} permissions</p>
            </div>
            <a href="{{ route('admin.roles.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition">
                + New Role
            </a>
        </div>
            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-50 border-b border-gray-100">
                    <tr>
                        ...
                        <th class="text-left px-6 py-3 font-semibold text-gray-600">Permissions</th>
                        <th class="text-left px-6 py-3 font-semibold text-gray-600">Users</th>
