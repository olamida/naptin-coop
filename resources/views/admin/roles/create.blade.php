<x-app-layout title="Create Role">
    <div class="max-w-2xl mx-auto space-y-6">
        ...
        <form method="POST" action="{{ route('admin.roles.store') }}" class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-6">
            @csrf
            <div>
                ...
                <p class="text-xs text-gray-400 mt-1">Use lowercase with hyphens (e.g. loan-officer)</p>
            </div>
