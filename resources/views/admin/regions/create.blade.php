<x-app-layout>
    <div class="max-w-2xl mx-auto space-y-6">
        <div>
            <h2 class="text-2xl font-bold text-[#0F172A]">Create Regional Center</h2>
            <p class="text-slate-500 text-sm mt-1">Add a new regional office location for the cooperative</p>
        </div>
        ...
        <form action="{{ route('admin.regions.store') }}" method="POST" class="bg-white rounded-[16px] shadow-sm border border-slate-200 p-6 space-y-5">
            @csrf
