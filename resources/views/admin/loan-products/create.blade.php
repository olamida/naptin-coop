<x-app-layout title="Create Loan Product">
    <div class="max-w-2xl space-y-6">
        <div class="flex items-center gap-3">
            ...
            <h2 class="text-xl font-bold text-[#0F172A]">Create Loan Product</h2>
        </div>
            ...
            <form method="POST" action="{{ route('admin.loan-products.store') }}" class="space-y-5">
                ...
                <div class="border-t border-slate-200 pt-5 bg-emerald-50 rounded-[10px] p-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="default_multiplier" value="{{ old('default_multiplier', 2) }}" step="0.1" min="0.1" max="10" required
                                   class="w-full px-3 py-2 border border-slate-300 rounded-[10px] text-sm focus:ring-2 focus:ring-blue-500 outline-none"
                                   placeholder="e.g., 2.0">
                        ...
                        <div>
                            ...
                            <input type="number" name="max_multiplier" value="{{ old('max_multiplier', 3) }}" step="0.1" min="0.1" max="10" required
                                   class="w-full px-3 py-2 border border-slate-300 rounded-[10px] text-sm focus:ring-2 focus:ring-blue-500 outline-none"
                                   placeholder="e.g., 4.0">
                        ...
                        <div>
                            ...
                            <input type="number" name="interest_rate_monthly" value="{{ old('interest_rate_monthly', 1.5) }}" step="0.01" min="0" max="100" required
                                   class="w-full px-3 py-2 border border-slate-300 rounded-[10px] text-sm focus:ring-2 focus:ring-blue-500 outline-none"
                                   placeholder="e.g., 1.5">
                        ...
                        <div>
                            ...
                            <input type="number" name="min_tenure_months" value="{{ old('min_tenure_months', 1) }}" min="1" max="120" required
                                   class="w-full px-3 py-2 border border-slate-300 rounded-[10px] text-sm focus:ring-2 focus:ring-blue-500 outline-none"
                                   placeholder="e.g., 1">
                ...
                <div class="border-t border-slate-200 pt-5 bg-blue-50 rounded-[10px] p-4">
                    ...
                    <div class="flex items-center gap-6 mb-3">
                        <label class="flex items-center gap-2 text-sm">
                            <input type="checkbox" name="requires_guarantor" value="1" {{ old('requires_guarantor', true) ? 'checked' : '' }}
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="min_guarantors" value="{{ old('min_guarantors', 1) }}" min="1" max="5"
                                   class="w-full px-3 py-2 border border-slate-300 rounded-[10px] text-sm focus:ring-2 focus:ring-blue-500 outline-none"
                                   placeholder="e.g., 1">
                        ...
                        <div>
                            ...
                            <input type="number" name="max_guarantors" value="{{ old('max_guarantors', 3) }}" min="1" max="5"
                                   class="w-full px-3 py-2 border border-slate-300 rounded-[10px] text-sm focus:ring-2 focus:ring-blue-500 outline-none"
                                   placeholder="e.g., 3">
                ...
                <div class="border-t border-slate-200 pt-5 bg-amber-50 rounded-[10px] p-4">
                    ...
                    <div class="flex items-center gap-6 flex-wrap">
                        <label class="flex items-center gap-2 text-sm">
                            <input type="checkbox" name="allow_multiplier_override" value="1" {{ old('allow_multiplier_override', true) ? 'checked' : '' }}
                                   class="w-4 h-4 text-blue-600 rounded">
                            Allow Multiplier Override (EXCO can increase multiplier for special cases)
                        </label>
                        <label class="flex items-center gap-2 text-sm">
                            <input type="checkbox" name="allow_deduction_cap_override" value="1" {{ old('allow_deduction_cap_override', true) ? 'checked' : '' }}
                                   class="w-4 h-4 text-blue-600 rounded">
